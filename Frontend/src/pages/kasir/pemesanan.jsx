        ...
        return (
            <div className='flex h-screen w-full'>
                <div class="w-full h-screen">
                    ...
                    <div className="m-3 h-screen font-sans font-light">
                        <div className="flex justify-between mb-2 bg-gray-700 text-white p-1.5 rounded-xl items-center">
                            <h1 className="ml-4 font-normal text-3xl text-lime-500 tracking-wider">Daftar Menu</h1>
                            <button className="hover:bg-lime-600 bg-lime-500 text-white font-normal uppercase text-xs px-4 py-3 rounded-md shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150 tracking-widest" type="button" onClick={() => this.Add()}>
                                Pesan
                            </button>
                        </div>
                        <div className="bg-gray-700 rounded-xl">
                            <button type="button" class="text-white ml-3 mt-3 bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-normal rounded-lg text-xl px-5 py-0.5 text-center inline-flex items-center mr-2 dark:bg-gray-700 dark:focus:ring-lime-500">
                                ...
                                {this.state.minuman.map((item) => (
                                    <div class="max-w-sm bg-white border m-3 border-gray-200 rounded-xl shadow dark:bg-slate-600 dark:border-gray-700" key={item.id_menu}>
                                        ...
                                        <div class="p-5 text-center">
                                            <h5 class="mb-2 text-2xl font-normal tracking-wide text-gray-900 dark:text-white">{item.nama_menu}</h5>
                                            <p class="mb-6 font-normal text-gray-700 dark:text-gray-300 tracking-wide"><span className="bg-blue-100 text-blue-800 font-normal mr-2 px-2.5 py-0.5 rounded-full dark:bg-slate-500 dark:text-white">{this.convertToRupiah(item.harga)}</span></p>
